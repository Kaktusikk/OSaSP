...
int main(int argc, char *argv[])
{
    if (argc != 4)
    {
        ...
        fputs("1st argument - 1st directory path.\n",stderr);
        fputs("2nd argument - 2nd directory path.\n",stderr);
        fputs("3rd argument - output file path.\n",stderr);
        return 0;
    }
